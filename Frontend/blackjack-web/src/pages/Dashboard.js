                    ...
                    <div className="text-start clean-blog-post">
                        <div className="row">
                            ...
                            <div className="col-lg-7">
                                ...
                                <div className="info"><span className="text-muted">Jan 16, 2018&nbsp;</span></div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo.</p><button className="btn btn-outline-primary btn-sm" type="button">View Replay</button>
                            </div>
                        </div>
                    </div>
                    <div className="clean-blog-post">
                        <div className="row">
                            ...
                            <div className="col-lg-7">
                                <h3>Lorem Ipsum dolor sit amet</h3>
                                <div className="info"><span className="text-muted">Jan 16, 2018</span></div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo.</p><button className="btn btn-outline-primary btn-sm" type="button">Read More</button>
                            </div>
                        </div>
                    </div>
                    <div className="clean-blog-post"></div>
                </div>
            </div>
        </section>
    </main>
